 ...
 */ "use strict";
class $88f6a882fc2954db$export$2e2bcd8739ae039 {
    constructor(){
    ...
    subscribe(eventName, callback) {
        ...
        if (!this.eventObject[eventName]) // Use object storage to improve the efficiency of deletion when logging out the callback
    ...
    clear(eventName) {
        ...
        else // clear the specified event
        delete this.eventObject[eventName];
    }
}


export {$88f6a882fc2954db$export$2e2bcd8739ae039 as default};
